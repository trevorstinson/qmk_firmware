...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_60_ansi(
	       ...
	       MO(2), KC_LALT, KC_LGUI,          KC_SPC,                                      KC_RGUI,   KC_LEFT, KC_DOWN,  KC_RIGHT),
  ...
  [1] = LAYOUT_60_ansi(
	       ...
	       KC_LCTRL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  \
	       KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_UP,   \
	       MO(2), KC_LGUI, KC_LALT,          KC_SPC,                                      KC_RGUI,   KC_LEFT, KC_DOWN,  KC_RIGHT),
  ...
  [2] = LAYOUT_60_ansi(
	       ...
	       KC_TRNS,   KC_LEFT,  KC_DOWN,  KC_RIGHT, RGB_TOG,  BL_OFF,  KC_TRNS,   KC_TRNS, KC_HOME, KC_PGUP, KC_LEFT, KC_RIGHT,          KC_TRNS,          \
