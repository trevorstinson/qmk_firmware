...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------|
   * |Fn  |Opt |Cmd |      Space           |Cmd |Left |Down|Right|
   * `-----------------------------------------------------------'
   */
  [0] = LAYOUT_60_ansi(
	       ...
	       LT(2, KC_ESC), KC_LALT, KC_LGUI,          LT(3, KC_SPC),                                      KC_RGUI,   KC_LEFT, KC_DOWN,  KC_RIGHT),

  /* Keymap 1: Windows Layer (Qwerty)
   * ,-----------------------------------------------------------.
   * |`~ |  1|  2|  3|  4|  5|  6|  7|  8|  9|  0|  -|  =|   Bs  |
   * |-----------------------------------------------------------|
   * |Tab  |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|    \|
   ...
   * |LShift  |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /| Up       |
   * |-----------------------------------------------------------|
   * |Fn  |Win |Alt |      Space           |Alt |Left |Down|Right|
   * `-----------------------------------------------------------'
   */
  [1] = LAYOUT_60_ansi(
	       KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, \
	       ...
	       KC_LCTRL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  \
	       KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_UP,   \
	       LT(2, KC_ESC), KC_LGUI, KC_LALT,          LT(3, KC_SPC),                                      KC_RGUI,   KC_LEFT, KC_DOWN,  KC_RIGHT),
   ...
   * |-----------------------------------------------------------|
   * |      |Cmb|off|on|   |   |   |   |Hme|PgU|Lef|Rig|        |
   * |-----------------------------------------------------------|
   * |        |Mac   |Win  |   |   |VolD|VolU|Mut|End|PgD|Dwn|        |
   * |-----------------------------------------------------------|
   * |    |    |    |                        |    |    |    |    |
   * `-----------------------------------------------------------'
   */
  [2] = LAYOUT_60_ansi(
	       ...
	       KC_TRNS,   CMB_TOG,  CMB_OFF,  CMB_ON, RGB_TOG,  BL_OFF,  KC_TRNS,   KC_TRNS, KC_HOME, KC_PGUP, KC_LEFT, KC_RIGHT,          KC_TRNS,          \
	       KC_TRNS,   DF(0),  DF(1),  KC_TRNS,  KC_TRNS,  KC_VOLD,   KC_VOLU, KC_MUTE, KC_END,  KC_PGDN,  KC_DOWN,           KC_TRNS,  \
